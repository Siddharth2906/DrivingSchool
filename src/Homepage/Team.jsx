...
const teamMembers = [
    { id: 1, name: "Full Name", position: "Trainer", image: img1 },
    { id: 2, name: "Full Name", position: "Trainer", image: img2 },
    { id: 3, name: "Full Name", position: "Trainer", image: img3 },
    { id: 4, name: "Full Name", position: "Trainer", image: img4 }
  ];
...
const Team = () => {
  ...
  <div className={`container mx-auto px-4 py-12 ${context.darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} `}>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 rounded-xl p-6 shadow-lg shadow-blue-500/10 border border-gray-700 hover:shadow-blue-500/20 transition-all duration-300">
