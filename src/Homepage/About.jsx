      ...
      <div id='about' className={`container mx-auto px-4 py-12 ${context.darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} `}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Helping You Clear the Test with Confidence</h1>
            <p>At our driving institute, we focus on empowering learners to succeed from day one. With well-structured lessons and knowledgeable mentors, we ensure you're thoroughly equipped to clear the test on your first try.</p>
            <p className="mb-4">Whether you're starting from scratch or brushing up your skills, our flexible sessions adapt to your needs. Experience a comfortable, encouraging setup that makes learning smooth and stress-free.</p>
