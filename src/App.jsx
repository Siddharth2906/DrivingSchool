...
function App() {
  ...
  return (
    <>
      <Topbar />
      <SEO 
      title="Priyanshi Driving School | Best Driving School in Indore"
      description="Join Priyanshi Driving School in Indore – experts in ladies-to-ladies driving, car, scooty, and bike learning classes."
      />
